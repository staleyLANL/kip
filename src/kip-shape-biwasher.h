...
#ifndef KIP_SHAPE_BIWASHER
#define KIP_SHAPE_BIWASHER
   ...
   if (ao != 0) {
      ...
      if (0 < q && q < qmin) {
         ...
         if (0 <= q.x && q.x <= rot.h) {
            q.y = rot.ey + q*dy;
            q.z = q*tar.z;
            return q(-oslope*(o.a + oslope*q.x), q.y, q.z, this, nonorm), true;
         }
      }
   }
   ...
   if (ai != 0) {
      ...
      if (0 < q && q < qmin) {
         ...
         if (0 <= q.x && q.x <= rot.h) {
            q.y = rot.ey + q*dy;
            q.z = q*tar.z;
            return q(islope*(i.a + islope*q.x), -q.y, -q.z, this, nonorm), true;
         }
      }
   }
