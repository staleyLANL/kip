...
#ifndef KIP_TRACE_DRY
#define KIP_TRACE_DRY
...
// a = tan(kip_pi/6) = tan(30)
// b = tan(kip_pi/3) = tan(60)

// nne
kip_dry_function(dry_nne) {
   /*static*/ const real a = op::tan(kip_pi/6);  // about 0.577
   return rotate<-3,real>(vars.eyeball,
      vars.t2e.back_0nn(h-vars.heps,  v-vars.veps),
...
kip_dry_function(dry_ene) {
   /*static*/ const real b = op::tan(kip_pi/3);  // about 1.732
   return rotate<-3,real>(vars.eyeball,
      vars.t2e.back_0nn(h-vars.heps,  v-vars.veps),
...
// a = tan(  kip_pi/8) = tan(22.5)
// b = tan(3*kip_pi/8) = tan(67.5)

// nnne
kip_dry_function(dry_nnne) {
   /*static*/ const real a = op::tan(kip_pi/8);  // about 0.414
   return rotate<-3,real>(vars.eyeball,
      vars.t2e.back_0nn(h-vars.heps,  v-vars.veps),
      vars.t2e.back_0nn(h-vars.heps-1,v-vars.veps+a));
}
...
kip_dry_function(dry_eene) {
   /*static*/ const real b = op::tan(3*kip_pi/8);  // about 2.414
   return rotate<-3,real>(vars.eyeball,
      vars.t2e.back_0nn(h-vars.heps,  v-vars.veps),
      vars.t2e.back_0nn(h-vars.heps-1,v-vars.veps+b));
}
...
// a = tan(  kip_pi/12) = tan(15)
// b = tan(5*kip_pi/12) = tan(75)

// ne75
kip_dry_function(dry_ne75) {
   /*static*/ const real a = op::tan(kip_pi/12);
   return rotate<-3,real>(vars.eyeball,
      vars.t2e.back_0nn(h-vars.heps,  v-vars.veps),
      vars.t2e.back_0nn(h-vars.heps-1,v-vars.veps+a));
}
...
kip_dry_function(dry_ne15) {
   /*static*/ const real b = op::tan(5*kip_pi/12);
   return rotate<-3,real>(vars.eyeball,
      vars.t2e.back_0nn(h-vars.heps,  v-vars.veps),
      vars.t2e.back_0nn(h-vars.heps-1,v-vars.veps+b));
}
